...
public class AddStoreFragment extends Fragment {
    ...
    private static final String _storaName = "storaName";
    ...
    String storaName2,address,phoneNo,email,operationHour,storeImage,registerId;
    ...
    public void store(){
        ...
        progressView.show();
        String urlRegister = "http://192.168.56.1/storeAdd.php";
    ...
    public void Storedetails(){
        ...
        progressView.setCancelable(false);
        progressView.show();
        String urlStore = "http://192.168.56.1/storeDetails.php";
        StringRequest requestRegister = new StringRequest(Request.Method.POST,urlStore,
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {
                        try {
                            ...
                            if(code.equals("success")) {//state,city,zip,password,type
                                storeId = jsonObject.getString("storeId");
                                storaName = jsonObject.getString("storaName");
                                latitude = jsonObject.getString("latitude");
                                longitude = jsonObject.getString("longitude");
                                userDetails.get(_storeId);
                                userDetails.get(_storaName);
                                userDetails.get(_latitude);
                                userDetails.get(_longitude);
                                //  Toast.makeText(getActivity(), "id ="+storeId, Toast.LENGTH_SHORT).show();
                            }
